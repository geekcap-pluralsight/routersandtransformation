...
public class TransformerExampleApplication implements CommandLineRunner {
	...
	public void run(String... args) throws Exception {
		...
		// Publish a family reservation as a JSON string
		familyReservationService.bookFamilyReservationAsJson(
				"{\"familyId\": 2, \"name\": \"Jones\", \"roomType\": \"Standard\", \"numberOfChildren\": 0}");
	}
