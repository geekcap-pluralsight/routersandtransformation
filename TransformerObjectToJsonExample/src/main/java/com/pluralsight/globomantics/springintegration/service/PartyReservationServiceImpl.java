...
import com.pluralsight.globomantics.springintegration.config.ToJsonChannelGateway;
...
public class PartyReservationServiceImpl implements PartyReservationService {
    ...
    @Autowired
    private ToJsonChannelGateway toJsonChannelGateway;
    ...
    public void handlePartyReservation(Message<PartyReservation> partyReservationMessage) {
        ...
        toJsonChannelGateway.toJson(partyReservation);
    }
}
